...
df = spark.read.format("csv")\
    ...
    .csv("s3a://estudo-lading-zone/*.csv")
...
df.write.format("parquet")\
        .mode("overwrite")\
        .save("s3a://estudo-processing/df-parquet-file.parquet")

# lendo arquivos parquet
df_parquet = spark.read.format("parquet")\
 .load("s3a://estudo-processing/df-parquet-file.parquet")
...
df_result.write.format("parquet")\
         .mode("overwrite")\
         .save("s3a://estudo-curated/df-result-file.parquet")
